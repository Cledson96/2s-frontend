...
export default function Signup_users() {
    ...
    function users() {
        ...
        post.catch((ref) => {
            if (ref.response.data === "usuario já cadastrado!") { setdataerror(ref.response.data); seterror(true) } else {
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    ...
                                    <li className="breadcrumb-item active">Cadastro usuario</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        <div className="form-group" style={{ minWidth: "70px", marginRight: "35px" }}>
                                            <label htmlFor="inputStatus">Acesso</label>
                                            <select name="acess" id="inputStatus" className="form-control custom-select" onChange={(e) => handleForm({ name: e.target.name, value: e.target.value, })}>
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <input onClick={() => users()} type="submit" value="Cadastrar novo usuario" className="btn btn-success float-right" />
                                        </div>
