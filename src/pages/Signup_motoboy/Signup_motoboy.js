...
export default function Signup_motoboy() {
   ...
   function handleReset()  {
    ...
    function motoboys(){
        ...
        post.catch((ref)=> {if(ref.response.data="motoboy já cadastrado!"){setdataerror(ref.response.data);seterror(true)}else{let err=ref.response.data.details.map((refe)=>{return (
